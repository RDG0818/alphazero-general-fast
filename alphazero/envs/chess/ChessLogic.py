...
# Code motivated/based on https://github.com/Zeta36/chess-alpha-zero/blob/master/src/chess_zero/env/chess.py
...
def all_input_planes(fen): # converts fen into (18, 8, 8) tensor
